...
class SWHear():
    ...
    def __init__(self,device=None,rate=None,updatesPerSecond=10, frequencySpacing=60, callback=None):
        ...
        self.device=device
        self.rate=rate
        self.getEveryNthFrequency = int(frequencySpacing / 20)
    ...
    def stream_readchunk(self):
        ...
        try:
            ...
            self.fftx, self.fft = getFFT(self.data,self.rate) #len 1102, 20hz / item
            self.fftx = self.fftx[0::self.getEveryNthFrequency]
            self.fft = self.fft[0::self.getEveryNthFrequency]
